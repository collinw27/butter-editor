...
void GLOutlinedRectangle::setup_GL()
{
    ...
    std::string vs_string = Graphics().get_builtin_shader(BuiltinShader::V_RECT_OUTLINED);
    ...
    std::string fs_string = Graphics().get_builtin_shader(BuiltinShader::F_RECT_OUTLINED);
